...
(function () {
  const secs = ['linha-flow', 'linha-reset', 'linha-recovery', 'linha-lumiere', 'rituais-comp'];
...
document.addEventListener('DOMContentLoaded', () => {
  document.querySelectorAll('.flow-header').forEach(header => {
    header.addEventListener('click', () => {
      ...
      document.querySelectorAll('.flow-card.open').forEach(c => c.classList.remove('open'));
